...
%% Page geometry
\ifafour
  \geometry{a4paper, top=20mm, bottom=20mm, inner=25mm, outer=10mm, footskip=5mm, nomarginpar}
\else
...
\newcommand{\basegostsectionfont}{\fontsize{14pt}{18pt}\selectfont\bfseries}
\newlength{\gostindent}
...
\AtBeginDocument{\setlength{\parindent}{12.5mm}}
