...
\defbibfilter{thesisAppendix}{\keyword{labauthor:zakirzyanov}\and\keyword{phd:zakirzyanov}\and\(\keyword{index:wos}\or\keyword{index:scopus}\or\keyword{index:vak}\)}
...
\defbibheading{headingAppendix}{\clearpage\chapter{Публикации}}
